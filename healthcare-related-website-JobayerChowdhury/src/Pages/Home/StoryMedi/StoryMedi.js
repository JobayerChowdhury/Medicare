...
const StoryMedi = () => {
    return (
        <div className="container srotyMedi my-5 py-5">
            <div className="row">
                <div className="col-md-6">
                    <img width="70%" src="https://demo.web3canvas.com/themeforest/medenin/images/about-img.jpg" alt="" />
                </div>
                <div className="col-md-6">
